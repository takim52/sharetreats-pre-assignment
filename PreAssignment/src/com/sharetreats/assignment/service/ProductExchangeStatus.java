...
public enum ProductExchangeStatus {
    ...
    INVALID_SHOP_CODE(-4, "올바르지 않은 상점 코드를 입력하였습니다, 상점 코드 : a~z,A~Z로 이루어진 6자리입니다."),
    INVALID_PRODUCT_CODE(-5, "올바르지 않은 상품 코드를 입력하였습니다, 상품 코드 : 숫자 0~9로 이루어진 9자리입니다"),
    INVALID_PARAMETER(-6, "입력값 오류 입니다. 상품 코드 : 숫자 0~9로 이루어진 9자리입니다, 상점 코드 : a~z,A~Z로 이루어진 6자리입니다. "),
